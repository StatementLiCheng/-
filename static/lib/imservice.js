...
// //获取群成员
// IMService.prototype.getGroupMembers = function (members) {
...
// 进入群聊
IMService.prototype.findGroupById = function (group) {
    // let group = restApi.findGroupById(groupId);
    // return new Group(group.uuid, group.name, group.avatar);
    // let pro = restApi.findGroupById(groupId);
    // pro.then((res) => {
    //     return new Group(res.uuid, res.name, res.avatar);
    // })
    return new Group(group.uuid, group.name, group.avatar);
};

// 进入私聊
IMService.prototype.findFriendById = function (user) {
