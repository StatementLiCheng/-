...
Page({
	...
	onLoad(options) {
		...
		var pro = restapi.findGroupById(groupId)
		// let group = service.findGroupById(groupId);
		pro.then(res => {
			let group = service.findGroupById(res);
		...
		// let pro1 = restapi.findGroupMembers(groupId);
		// pro1.then((res) => {
		// 	console.log(res)
		// 	let groupMembers = service.getGroupMembers(res);
		// 	this.setData({
		// 		currentUser: currentUser,
